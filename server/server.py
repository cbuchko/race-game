...
class Server(socketio.Namespace):
    ...
    def on_connect(self, sid, environ):
        ...
        # TODO: Figure out how to only send to the original connected client
        ...
        # TODO: If game has already started, then send an add_player event
        # instead maybe
        # event instead of a players_info event
